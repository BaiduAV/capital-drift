...
export const DRIFT_VOL: Record<AssetClass, Record<RegimeId, DriftVol>> = {
  ...
  ETF: {
    CALM:            { drift: 0.00018, vol: 0.010 },
    BULL:            { drift: 0.00040, vol: 0.011 },
    BEAR:            { drift: -0.00035, vol: 0.012 },
    CRISIS:          { drift: -0.00100, vol: 0.020 },
    CRYPTO_EUPHORIA: { drift: 0.00035, vol: 0.012 },
  },
  FII: {
    CALM:            { drift: 0.00015, vol: 0.006 },
    BULL:            { drift: 0.00030, vol: 0.007 },
    BEAR:            { drift: -0.00015, vol: 0.008 },
    CRISIS:          { drift: -0.00070, vol: 0.014 },
    CRYPTO_EUPHORIA: { drift: 0.00025, vol: 0.007 },
  },
  CRYPTO_MAJOR: {
    CALM:            { drift: 0.00025, vol: 0.030 },
    BULL:            { drift: 0.00060, vol: 0.035 },
    BEAR:            { drift: -0.00080, vol: 0.045 },
    CRISIS:          { drift: -0.00160, vol: 0.070 },
    CRYPTO_EUPHORIA: { drift: 0.00150, vol: 0.060 },
  },
  CRYPTO_ALT: {
    CALM:            { drift: 0.00030, vol: 0.045 },
    BULL:            { drift: 0.00080, vol: 0.055 },
    BEAR:            { drift: -0.00110, vol: 0.075 },
    CRISIS:          { drift: -0.00220, vol: 0.110 },
    CRYPTO_EUPHORIA: { drift: 0.00200, vol: 0.100 },
  },
  FX: {
