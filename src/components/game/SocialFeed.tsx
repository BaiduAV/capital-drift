        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-4 mt-1.5">
            ...
            <button
              ...
              aria-label={locale === 'pt-BR' ? 'Republicar' : 'Repost'}
              title={locale === 'pt-BR' ? 'Republicar' : 'Repost'}
              aria-pressed={interactions.reposted}
              className={`flex items-center gap-1 text-[10px] transition-all duration-200 cursor-pointer hover:scale-110 active:scale-95 rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
