        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-4 mt-1.5">
            ...
            <button
              ...
              aria-label={locale === 'pt-BR' ? `${formatCount(repostCount)} reposts` : `${formatCount(repostCount)} reposts`}
            ...
            <button
              ...
              aria-label={locale === 'pt-BR' ? `${formatCount(likeCount)} curtidas` : `${formatCount(likeCount)} likes`}
