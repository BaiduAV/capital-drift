...
function PostCard({
  ...
  const replyLabel = locale === 'pt-BR' ? `${post.engagement.replies} respostas` : `${post.engagement.replies} replies`;
  const repostLabel = locale === 'pt-BR' ? `${repostCount} repostagens` : `${repostCount} reposts`;
  const likeLabel = locale === 'pt-BR' ? `${likeCount} curtidas` : `${likeCount} likes`;
