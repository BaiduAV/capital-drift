    ...
    <div className="flex min-h-screen w-full bg-background">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <footer className="flex items-center justify-center border-t border-border/50 px-3 py-1.5 bg-card/50">
          <button
            className="text-[10px] text-muted-foreground/50 font-mono hover:text-muted-foreground transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded"
            onClick={() => {
