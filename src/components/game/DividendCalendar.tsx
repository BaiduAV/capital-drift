        ...
        <div className="divide-y divide-border/30 max-h-[280px] overflow-auto scrollbar-terminal">
          {upcoming.map(d => (
            <div
              ...
              className="flex items-center justify-between px-4 py-2 cursor-pointer hover:bg-muted/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background group"
            >
              <span className="sr-only">{locale === 'pt-BR' ? 'Negociar' : 'Trade'}</span>
